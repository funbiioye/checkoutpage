...
import { Menu, MenuButton, Image } from "@chakra-ui/react";
    ...
    <Box h="100%" w="100%" maxWidth="100vw" mb="525px">
      ...
      <Box w="100vw">
        <Flex>
          ...
          <Text color="black" mt="22px" ml="5px">
            back
          </Text>
          <Breadcrumb
            spacing="8px"
      ...
      <Flex mt="79px">
        <Box ml="100px" mr="236px">
          ...
          <Flex mt="16px">
            ...
            <Text ml="60px" color="#646464">
              {" "}
              Oluwasegun Elijah Adebisi
            </Text>
          </Flex>
          <Flex>
            ...
            <Text ml="60px" color="#646464">
              {" "}
              Oluwasegunadebisi617@gmail.com
            </Text>
          </Flex>
          <Flex>
            <Text color="#27A599">Phone No:</Text>
            <Text ml="34px" color="#646464">
              {" "}
              08163462779
            </Text>
          </Flex>
        ...
        <Box bg="#27A599" w="400px" h="491px" mr="94px">
          ...
          <Flex>
            ...
            <Box>
              ...
              <Text fontSize="14px" fontWeight="400" ml="14px">
                1 pack
              </Text>
            </Box>
          ...
          <Box borderBottom="1px solid #fff" ml="32px" mr="30px">
            <Flex
              ...
              alignItems="center"
            >
              <Text fontSize="12px" fontWeight="400" font="poppins" ml="9px">
                {" "}
                Total
              </Text>
              <Text fontSize="16px" fontWeight="600" font="poppins" ml="130px">
                {" "}
                NGN 2400
              </Text>
            </Flex>
